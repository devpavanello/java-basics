...
public class Strings_Exercicio_03v3
{

	public static void main(String[] args)
	{
		// Scanner para colocarmos qualquer tipo de frase.
				...
				// A frase recebe a minha frase inteira e transforma tudo em maiusculo e
				// tira o espaço do começo e do final.
				frase = teclado.nextLine().toUpperCase().trim();
				// Processamento
				...
				System.out.println("Frase 2X = " + frase2x);
