...
public class Strings_Exercicio_CPF {
	public static void main(String[] args) {
		...
		// obtém o 2º dígito verificador informado (DV1i)
		...
		// se resto da divisão (DV1c/11) < 2 então DV1c = 0 senão DV1c = 11 - DV1c
		DV1c = calculo % 11;
		if (DV1c < 2)
			DV1c = 0;
		else
		...
		// se resto da divisão (DV2c/11) < 2 então DV2c = 0 senão DV2c = 11 - dv2c
		DV2c = calculo % 11;
		if (DV2c < 2)
			DV2c = 0;
		else
